...
<head>
	...
	<link href="http://<?=Configure::read('domain.url')?>/assets/global/plugins/morris/morris.css" rel="stylesheet" type="text/css" />
	<link href="http://<?=Configure::read('domain.url')?>/assets/global/plugins/fullcalendar/fullcalendar.min.css" rel="stylesheet" type="text/css" />
	<link href="http://<?=Configure::read('domain.url')?>/assets/global/plugins/jqvmap/jqvmap/jqvmap.css" rel="stylesheet" type="text/css" />
...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner ">
		...
		<div class="page-logo">
			<a href="index.html">
				<img src="http://<?=Configure::read('domain.url')?>/assets/layouts/layout/img/logo.png" alt="logo" class="logo-default" /> </a>
						...
						<li>
							<ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
								<li>
									<a href="#">
                                                <span class="photo">
                                                    <img src="http://<?=Configure::read('domain.url')?>/assets/layouts/layout3/img/avatar2.jpg" class="img-circle" alt=""> </span>
                                                <span class="subject">
								...
								<li>
									<a href="#">
                                                <span class="photo">
                                                    <img src="http://<?=Configure::read('domain.url')?>/assets/layouts/layout3/img/avatar3.jpg" class="img-circle" alt=""> </span>
                                                <span class="subject">
								...
								<li>
									<a href="#">
                                                <span class="photo">
                                                    <img src="http://<?=Configure::read('domain.url')?>/assets/layouts/layout3/img/avatar1.jpg" class="img-circle" alt=""> </span>
                                                <span class="subject">
						...
						<div class="portlet-body">
							...
							<div class="table-scrollable table-scrollable-borderless">
								<table class="table table-hover table-light">
									...
									<tr>
										<td class="fit">
											<img class="user-pic rounded" src="http://<?=Configure::read('domain.url')?>/assets/pages/media/users/avatar4.jpg"> </td>
										<td>
									...
									<tr>
										<td class="fit">
											<img class="user-pic rounded" src="http://<?=Configure::read('domain.url')?>/assets/pages/media/users/avatar5.jpg"> </td>
										<td>
									...
									<tr>
										<td class="fit">
											<img class="user-pic rounded" src="http://<?=Configure::read('domain.url')?>/assets/pages/media/users/avatar6.jpg"> </td>
										<td>
									...
									<tr>
										<td class="fit">
											<img class="user-pic rounded" src="http://<?=Configure::read('domain.url')?>/assets/pages/media/users/avatar7.jpg"> </td>
										<td>
							...
							<div class="scroller" style="height: 338px;" data-always-visible="1" data-rail-visible1="0" data-handle-color="#D7DCE2">
								<div class="general-item-list">
									<div class="item">
										<div class="item-head">
											<div class="item-details">
												<img class="item-pic rounded" src="http://<?=Configure::read('domain.url')?>/assets/pages/media/users/avatar4.jpg">
									...
									<div class="item">
										<div class="item-head">
											<div class="item-details">
												<img class="item-pic rounded" src="http://<?=Configure::read('domain.url')?>/assets/pages/media/users/avatar3.jpg">
									...
									<div class="item">
										<div class="item-head">
											<div class="item-details">
												<img class="item-pic rounded" src="http://<?=Configure::read('domain.url')?>/assets/pages/media/users/avatar6.jpg">
												<a href="" class="item-name primary-link">Nick Larson</a>
									...
									<div class="item">
										<div class="item-head">
											<div class="item-details">
												<img class="item-pic rounded" src="http://<?=Configure::read('domain.url')?>/assets/pages/media/users/avatar7.jpg">
												<a href="" class="item-name primary-link">Nick Larson</a>
									...
									<div class="item">
										<div class="item-head">
											<div class="item-details">
												<img class="item-pic rounded" src="http://<?=Configure::read('domain.url')?>/assets/pages/media/users/avatar9.jpg">
									...
									<div class="item">
										<div class="item-head">
											<div class="item-details">
												<img class="item-pic rounded" src="http://<?=Configure::read('domain.url')?>/assets/pages/media/users/avatar8.jpg">
									...
									<div class="item">
										<div class="item-head">
											<div class="item-details">
												<img class="item-pic rounded" src="http://<?=Configure::read('domain.url')?>/assets/pages/media/users/avatar2.jpg">
					...
					<div class="portlet light ">
						...
						<div class="portlet-body">
							<div id="region_statistics_loading">
								<img src="http://<?=Configure::read('domain.url')?>/assets/global/img/loading.gif" alt="loading" /> </div>
					...
					<div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
						...
						<ul class="media-list list-items">
							<li class="media">
								...
								<img class="media-object" src="http://<?=Configure::read('domain.url')?>/assets/layouts/layout/img/avatar3.jpg" alt="...">
							...
							<li class="media">
								<img class="media-object" src="http://<?=Configure::read('domain.url')?>/assets/layouts/layout/img/avatar1.jpg" alt="...">
								<div class="media-body">
							...
							<li class="media">
								...
								<img class="media-object" src="http://<?=Configure::read('domain.url')?>/assets/layouts/layout/img/avatar4.jpg" alt="...">
								<div class="media-body">
							...
							<li class="media">
								<img class="media-object" src="http://<?=Configure::read('domain.url')?>/assets/layouts/layout/img/avatar2.jpg" alt="...">
								<div class="media-body">
						...
						<ul class="media-list list-items">
							<li class="media">
								...
								<img class="media-object" src="http://<?=Configure::read('domain.url')?>/assets/layouts/layout/img/avatar6.jpg" alt="...">
								<div class="media-body">
							...
							<li class="media">
								...
								<img class="media-object" src="http://<?=Configure::read('domain.url')?>/assets/layouts/layout/img/avatar7.jpg" alt="...">
								<div class="media-body">
							...
							<li class="media">
								<img class="media-object" src="http://<?=Configure::read('domain.url')?>/assets/layouts/layout/img/avatar8.jpg" alt="...">
								<div class="media-body">
							...
							<li class="media">
								...
								<img class="media-object" src="http://<?=Configure::read('domain.url')?>/assets/layouts/layout/img/avatar9.jpg" alt="...">
								<div class="media-body">
							...
							<li class="media">
								<img class="media-object" src="http://<?=Configure::read('domain.url')?>/assets/layouts/layout/img/avatar10.jpg" alt="...">
								<div class="media-body">
							...
							<li class="media">
								...
								<img class="media-object" src="http://<?=Configure::read('domain.url')?>/assets/layouts/layout/img/avatar11.jpg" alt="...">
								<div class="media-body">
					...
					<div class="page-quick-sidebar-item">
						<div class="page-quick-sidebar-chat-user">
							...
							<div class="page-quick-sidebar-chat-user-messages">
								<div class="post out">
									<img class="avatar" alt="" src="http://<?=Configure::read('domain.url')?>/assets/layouts/layout/img/avatar3.jpg" />
									<div class="message">
										<span class="arrow"></span>
								...
								<div class="post in">
									<img class="avatar" alt="" src="http://<?=Configure::read('domain.url')?>/assets/layouts/layout/img/avatar2.jpg" />
									<div class="message">
										<span class="arrow"></span>
...
<script src="http://<?=Configure::read('domain.url')?>/assets/global/plugins/bootstrap-daterangepicker/daterangepicker.js" type="text/javascript"></script>
<script src="http://<?=Configure::read('domain.url')?>/assets/global/plugins/morris/morris.min.js" type="text/javascript"></script>
<script src="http://<?=Configure::read('domain.url')?>/assets/global/plugins/morris/raphael-min.js" type="text/javascript"></script>
<script src="http://<?=Configure::read('domain.url')?>/assets/global/plugins/counterup/jquery.waypoints.min.js" type="text/javascript"></script>
<script src="http://<?=Configure::read('domain.url')?>/assets/global/plugins/counterup/jquery.counterup.min.js" type="text/javascript"></script>
<script src="http://<?=Configure::read('domain.url')?>/assets/global/plugins/amcharts/amcharts/amcharts.js" type="text/javascript"></script>
<script src="http://<?=Configure::read('domain.url')?>/assets/global/plugins/amcharts/amcharts/serial.js" type="text/javascript"></script>
<script src="http://<?=Configure::read('domain.url')?>/assets/global/plugins/amcharts/amcharts/pie.js" type="text/javascript"></script>
<script src="http://<?=Configure::read('domain.url')?>/assets/global/plugins/amcharts/amcharts/radar.js" type="text/javascript"></script>
<script src="http://<?=Configure::read('domain.url')?>/assets/global/plugins/amcharts/amcharts/themes/light.js" type="text/javascript"></script>
<script src="http://<?=Configure::read('domain.url')?>/assets/global/plugins/amcharts/amcharts/themes/patterns.js" type="text/javascript"></script>
<script src="http://<?=Configure::read('domain.url')?>/assets/global/plugins/amcharts/amcharts/themes/chalk.js" type="text/javascript"></script>
<script src="http://<?=Configure::read('domain.url')?>/assets/global/plugins/amcharts/ammap/ammap.js" type="text/javascript"></script>
<script src="http://<?=Configure::read('domain.url')?>/assets/global/plugins/amcharts/ammap/maps/js/worldLow.js" type="text/javascript"></script>
<script src="http://<?=Configure::read('domain.url')?>/assets/global/plugins/amcharts/amstockcharts/amstock.js" type="text/javascript"></script>
<script src="http://<?=Configure::read('domain.url')?>/assets/global/plugins/fullcalendar/fullcalendar.min.js" type="text/javascript"></script>
<script src="http://<?=Configure::read('domain.url')?>/assets/global/plugins/flot/jquery.flot.min.js" type="text/javascript"></script>
<script src="http://<?=Configure::read('domain.url')?>/assets/global/plugins/flot/jquery.flot.resize.min.js" type="text/javascript"></script>
<script src="http://<?=Configure::read('domain.url')?>/assets/global/plugins/flot/jquery.flot.categories.min.js" type="text/javascript"></script>
<script src="http://<?=Configure::read('domain.url')?>/assets/global/plugins/jquery-easypiechart/jquery.easypiechart.min.js" type="text/javascript"></script>
<script src="http://<?=Configure::read('domain.url')?>/assets/global/plugins/jquery.sparkline.min.js" type="text/javascript"></script>
<script src="http://<?=Configure::read('domain.url')?>/assets/global/plugins/jqvmap/jqvmap/jquery.vmap.js" type="text/javascript"></script>
<script src="http://<?=Configure::read('domain.url')?>/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.russia.js" type="text/javascript"></script>
<script src="http://<?=Configure::read('domain.url')?>/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.world.js" type="text/javascript"></script>
<script src="http://<?=Configure::read('domain.url')?>/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.europe.js" type="text/javascript"></script>
<script src="http://<?=Configure::read('domain.url')?>/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.germany.js" type="text/javascript"></script>
<script src="http://<?=Configure::read('domain.url')?>/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.usa.js" type="text/javascript"></script>
<script src="http://<?=Configure::read('domain.url')?>/assets/global/plugins/jqvmap/jqvmap/data/jquery.vmap.sampledata.js" type="text/javascript"></script>
<!-- END PAGE LEVEL PLUGINS -->
<!-- BEGIN THEME GLOBAL SCRIPTS -->
<script src="http://<?=Configure::read('domain.url')?>/assets/global/scripts/app.min.js" type="text/javascript"></script>
<!-- END THEME GLOBAL SCRIPTS -->
<!-- BEGIN PAGE LEVEL SCRIPTS -->
<script src="http://<?=Configure::read('domain.url')?>/assets/pages/scripts/dashboard.min.js" type="text/javascript"></script>
